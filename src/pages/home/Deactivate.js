...
import {AsyncStorage, Image, Platform, StyleSheet, Text, TextInput, TouchableOpacity, View, Alert} from 'react-native';
...
class DeactivateScreen extends Component {
    ...
    next = () => {
        if (this.state.password === "") {
            ...
            user.deactivateAccount(this.state.password).then((response) => {
            ...
            <View style={{ backgroundColor: 'white', flex: 1 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'column' }}>
                    <View style={{ flex: 3, alignItems: 'center', justifyContent: 'flex-end' }}>
                        ...
                        <Text style={{ fontFamily: Platform.OS === 'ios' ? "Courier New" : "monospace", fontSize: 16, fontWeight: "bold", textAlign:'center', color: '#FBB06E' }}>
                            Please note that by deactivating your account you can't login in seven days
                        </Text>
                    </View>
                    ...
                    <View style={{ flex: 1, justifyContent: 'space-around', padding: 5 }}>
                        <TouchableOpacity style={{ alignItems: 'center' }} onPress={this.next} disabled={this.state.isFetching}>
                            <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#FA986C', '#F97579', '#F75385']} style={styles.button}>
                                <Text style={styles.button_text}>DEACTIVATE</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </View>
...
export default consume(DeactivateScreen)